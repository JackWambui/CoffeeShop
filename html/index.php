    ...
    <header>
        <nav>
            ...
            <ul class="nav-links">
                ...
                <!-- <li><a href="../html/loginIn.html">Login</a></li> -->
    ...
    <main>
        <section class="hero">
            <div class="hero-content">
                <p><b>Warm Welcome: A Cup of Inspiration</b></p>
                <p>Passionate Brewing: Every cup with care</p>
        ...
        <section class="grid-container" id="grid-container-1">
            ...
            <div class="grid-container-description">
                ...
                <p>
                    <span class="span-1">
                        More Than Coffee:
                    </span> We build a community.
                </p>
                <p>
                    <span class="span-1">
                        Stay & Enjoy:
                    </span>Drinks and conversation.
                </p>
                <p>
                    <span class="span-1">
                        Tasty Selection:
                    </span> Pastries, sandwiches, snacks.
                </p>
                <p>
                     <span class="span-1">
                    Perfect Spot:
                    </span> Meet, work, or relax.
                </p>
            </div> 
        </section>
